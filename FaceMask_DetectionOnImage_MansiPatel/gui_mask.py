...
Title_Label = Label(Tops,font=('Comic Sans MS',20,'bold'),text = "'Mask Prediction on an Image' \n\t   using NLP\t\t",pady=9,bg= 'white',fg='red',justify ="center")
...
Label_1 =Label(MainFrame, font=('lato black', 17,'bold'), text="\tFace-MASK prediction on a person's face",padx=2,pady=2, bg="white",fg ="black")
